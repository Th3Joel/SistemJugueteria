...
func ConnectDB() {
	...
	dsn := "VwgHAVyMup7XfY6.root:h057gQ1L9FQL3rCL@tcp(gateway01.us-east-1.prod.aws.tidbcloud.com:4000)/jugueteria?parseTime=true&tls=true"
	var db *gorm.DB
	var err error
	...
	for {
		...
		fmt.Println("...Reintentando conectar a la base de datos")
